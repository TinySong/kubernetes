...
type LinuxContainerResources struct {
	...
	// Blkio throttle read bps. Default: 0 (not specified).
	StorageReadBandwidthLimit int64 `protobuf:"varint,8,opt,name=storage_read_bandwidth_limit,json=storageReadBandwidthLimit,proto3" json:"storage_read_bandwidth_limit,omitempty"`
	// Blkio throttle write bps. Default: 0 (not specified).
	StorageWriteBandwidthLimit int64 `protobuf:"varint,9,opt,name=storage_write_bandwidth_limit,json=storageWriteBandwidthLimit,proto3" json:"storage_write_bandwidth_limit,omitempty"`
	// Blkio throttle read iops. Default: 0 (not specified).
	StorageReadIopsLimit int64 `protobuf:"varint,10,opt,name=storage_read_iops_limit,json=storageReadIopsLimit,proto3" json:"storage_read_iops_limit,omitempty"`
	// Blkio throttle write iops. Default: 0 (not specified).
	StorageWriteIopsLimit int64 `protobuf:"varint,11,opt,name=storage_write_iops_limit,json=storageWriteIopsLimit,proto3" json:"storage_write_iops_limit,omitempty"`
}
...
func (m *LinuxContainerResources) GetStorageReadBandwidthLimit() int64 {
	if m != nil {
		return m.StorageReadBandwidthLimit
	}
	return 0
}

func (m *LinuxContainerResources) GetStorageWriteBandwidthLimit() int64 {
	if m != nil {
		return m.StorageWriteBandwidthLimit
	}
	return 0
}

func (m *LinuxContainerResources) GetStorageReadIopsLimit() int64 {
	if m != nil {
		return m.StorageReadIopsLimit
	}
	return 0
}

func (m *LinuxContainerResources) GetStorageWriteIopsLimit() int64 {
	if m != nil {
		return m.StorageWriteIopsLimit
	}
	return 0
}
...
func (m *LinuxContainerResources) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.StorageReadBandwidthLimit != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.StorageReadBandwidthLimit))
	}
	if m.StorageWriteBandwidthLimit != 0 {
		dAtA[i] = 0x48
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.StorageWriteBandwidthLimit))
	}
	if m.StorageReadIopsLimit != 0 {
		dAtA[i] = 0x50
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.StorageReadIopsLimit))
	}
	if m.StorageWriteIopsLimit != 0 {
		dAtA[i] = 0x58
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.StorageWriteIopsLimit))
	}
	return i, nil
}
...
func (m *LinuxContainerResources) Size() (n int) {
	...
	if m.StorageReadBandwidthLimit != 0 {
		n += 1 + sovApi(uint64(m.StorageReadBandwidthLimit))
	}
	if m.StorageWriteBandwidthLimit != 0 {
		n += 1 + sovApi(uint64(m.StorageWriteBandwidthLimit))
	}
	if m.StorageReadIopsLimit != 0 {
		n += 1 + sovApi(uint64(m.StorageReadIopsLimit))
	}
	if m.StorageWriteIopsLimit != 0 {
		n += 1 + sovApi(uint64(m.StorageWriteIopsLimit))
	}
	return n
}
...
func (this *LinuxContainerResources) String() string {
	...
	s := strings.Join([]string{`&LinuxContainerResources{`,
		...
		`StorageReadBandwidthLimit:` + fmt.Sprintf("%v", this.StorageReadBandwidthLimit) + `,`,
		`StorageWriteBandwidthLimit:` + fmt.Sprintf("%v", this.StorageWriteBandwidthLimit) + `,`,
		`StorageReadIopsLimit:` + fmt.Sprintf("%v", this.StorageReadIopsLimit) + `,`,
		`StorageWriteIopsLimit:` + fmt.Sprintf("%v", this.StorageWriteIopsLimit) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *LinuxContainerResources) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StorageReadBandwidthLimit", wireType)
			}
			m.StorageReadBandwidthLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StorageReadBandwidthLimit |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StorageWriteBandwidthLimit", wireType)
			}
			m.StorageWriteBandwidthLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StorageWriteBandwidthLimit |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StorageReadIopsLimit", wireType)
			}
			m.StorageReadIopsLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StorageReadIopsLimit |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StorageWriteIopsLimit", wireType)
			}
			m.StorageWriteIopsLimit = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StorageWriteIopsLimit |= (int64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
